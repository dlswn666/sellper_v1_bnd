 ...
 * @param {string} data.certificationType - KC 인증 정보 (｢전기용품 및 생활용품 안전관리법｣에 따른 공급자적합성확인대상제품에 한함)
 * @param {string} data.color - 색상
 * @param {string} data.components - 상품 구성
 * @param {string} data.material - 소재
 * @param {string} data.manufacturer - 제조사
 * @param {string} data.importer - 수입사
 * @param {string} data.producer - 제조국
 * @param {string} data.size - 사이즈
 * @param {string} data.installedCharge - 배송 설치 비용
