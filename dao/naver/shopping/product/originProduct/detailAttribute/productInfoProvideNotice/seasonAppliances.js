 ...
 * @param {string} data.ratedVoltage - 정격전압W
 ...
 * @param {string} data.area - 냉난방 면적
 * @param {string} data.installedCharge - 추가 설치 비용
 * @param {string} data.warrantyPolicy - 품질 보증 기준
 * @param {string} data.afterServiceDirector - A/S 책임자 및 전화 번호
 *
 * @returns {Object}
 */
export function createSeasonAppliances(data) {
    const {
        returnCostReason,
        noRefundReason,
