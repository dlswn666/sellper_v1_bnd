 ...
 *
 * @param {object} data.releaseDate - 동일 모델의 출시연월 (<'yyyy-MM'> 형식, 최대 300자)
 * @param {string} data.releaseDate.year - 출시연도
 * @param {string} data.releaseDate.month - 출시월
 * @param {string} data.releaseDate.monthValue - 출시월
 * @param {string} data.releaseDate.leapYear - 윤년 여부
 *
 ...
 */
export function createSportsEquipment(data) {
    const {
        returnCostReason,
        noRefundReason,
